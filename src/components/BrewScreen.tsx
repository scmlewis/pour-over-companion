...
export const BrewScreen: React.FC<BrewScreenProps> = ({
  ...
  return (
    ...
    >
      ...
      <motion.div variants={headerVariants} className="shrink-0 -mx-4 px-4 bg-[#0a0a08] border-b border-white/[0.04] flex items-center justify-between py-2 sticky top-0 z-20">
          <button
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden -mx-4 px-4 pt-[calc(env(safe-area-inset-top)+2.5rem)] pb-2 space-y-3">
