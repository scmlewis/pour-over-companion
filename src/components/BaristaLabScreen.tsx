...
export const BaristaLabScreen: React.FC<BaristaLabScreenProps> = ({
  ...
  const DEFECTS = [
    { id: 'sour', nameZh: '尖銳酸感 / 草本澀味 (Sour / Vegetal)', causeZh: '主要原因：萃取不足 (Under-extraction) 或水溫過低。', fixZh: '調校方針：\n1. 研磨度調細 1~2 格\n2. 水溫提升 +2°C ~ +3°C (92°C~95°C)\n3. 延長悶蒸時間 5~10 秒\n4. 增加繞圈注水力度提升擾動' },
    { id: 'bitter', nameZh: '苦尾刮喉 / 乾澀收斂 (Bitter / Astringent)', causeZh: '主要原因：過度萃取 (Over-extraction) 或細粉堵塞通道效應 (Channeling)。', fixZh: '調校方針：\n1. 研磨度調粗 1~2 格\n2. 水溫降低 -2°C ~ -4°C (86°C~89°C)\n3. 縮短總注水時間，採用大水流分段\n4. 水柱靠近粉面中心，避免沖刷濾紙邊緣' },
    { id: 'weak', nameZh: '水感空洞 / 風味平淡 (Watery / Hollow)', causeZh: '主要原因：粉水比過大 (水太多) 或萃取濃度過低。', fixZh: '調校方針：\n1. 調整粉水比至 1:14 ~ 1:15\n2. 增加粉量 1~2 克\n3. 採用中心點滴或多段注水提升醇厚度' },
    { id: 'clogged', nameZh: '下水停滯 / 泥濘積水 (Stalled Flow / Muddy)', causeZh: '主要原因：刀盤細粉過多，或晃動濾杯造成微粉沉降堵塞濾紙毛孔。', fixZh: '調校方針：\n1. 減少下壺搖晃 (Swirl) 力度\n2. 研磨前水滴防靜電 (RDT) 減少細粉吸附\n3. 調粗研磨度或使用滲透流手法' },
  ];
      ...
      <div>
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-[10px] text-[#f0eeeb]/40 font-mono">粉水濃度比 (Ratio)</div>
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2 text-center text-xs">
                  <div className="p-2.5 rounded-2xl bg-black/30 space-y-1">
                    <div className="text-[10px] font-mono text-[#f0eeeb]/40">溫柔點滴</div>
                    <div className="text-sm font-black font-mono text-amber-400">2.0 ~ 3.0</div>
                    <div className="text-[10px] text-[#f0eeeb]/50">極低擾動·花香乾淨</div>
                  </div>
                  <div className="p-2.5 rounded-2xl bg-amber-500/8 border border-amber-500/20 space-y-1">
                    ...
                    <div className="text-[10px] text-[#f0eeeb]/70">標準分段·酸甜平衡</div>
                  </div>
                  <div className="p-2.5 rounded-2xl bg-black/30 space-y-1">
                    <div className="text-[10px] font-mono text-[#f0eeeb]/40">大水流擾動</div>
                    <div className="text-sm font-black font-mono text-amber-400">6.5 ~ 8.0</div>
                    <div className="text-[10px] text-[#f0eeeb]/50">高擾動·醇厚度強</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4 animate-fade-slide-up">
              ...
              <div className="p-4 space-y-3.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-xs font-bold text-amber-400 font-mono">
                    ...
                    <span>手沖壺水溫熱損耗模擬</span>
                  </div>
                  <span className="text-[10px] font-mono text-[#f0eeeb]/40">物理衰減模型</span>
                </div>
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-[#f0eeeb]/40">起始水溫 (°C)</label>
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-[#f0eeeb]/40">手沖壺材質</label>
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="p-2.5 rounded-2xl bg-black/30 space-y-0.5">
                    <span className="text-[10px] font-mono text-[#f0eeeb]/40">60 秒後</span>
                    <div className="text-base font-black font-mono text-amber-400">{temp60s}°C</div>
                  </div>
                  <div className="p-2.5 rounded-2xl bg-black/30 space-y-0.5">
                    <span className="text-[10px] font-mono text-[#f0eeeb]/40">120 秒後</span>
                    <div className="text-base font-black font-mono text-amber-400">{temp120s}°C</div>
                  </div>
                  <div className="p-2.5 rounded-2xl bg-black/30 space-y-0.5">
                    <span className="text-[10px] font-mono text-[#f0eeeb]/40">180 秒後</span>
            ...
            <div className="bezel-card">
              <div className="p-4 space-y-2.5">
                <div className="text-xs font-bold text-amber-400 font-mono">SCA 精品咖啡水質標準</div>
                <div className="space-y-1.5 text-xs">
                  {[
                    { label: '總溶解固體 (TDS)', value: '75 ~ 150 ppm' },
                    { label: '鈣鎂總硬度 (GH)', value: '50 ~ 70 ppm' },
                    { label: '鹼度緩衝 (KH)', value: '40 ppm' },
                    { label: '酸鹼值 (pH)', value: '6.5 ~ 7.5' },
                  ].map((item, i) => (
          ...
          <div className="space-y-4 animate-fade-slide-up">
            ...
            <div className="bezel-card">
              <div className="p-4 space-y-2.5 text-xs">
                <div className="text-xs font-bold text-amber-400 font-mono">主流磨豆機手沖刻度參考</div>
                <div className="space-y-1.5 font-mono">
                  {[
                    { name: 'Comandante C40 MK4', clicks: '22 ~ 26 Clicks' },
                    { name: '1Zpresso K-Ultra', clicks: '7.0 ~ 8.0' },
                    { name: 'Timemore C2 / C3', clicks: '15 ~ 18 格' },
        ...
        {activeTab === 'tips' && (
          <div className="space-y-4 animate-fade-slide-up">
            ...
            <div className="bezel-card">
              <div className="p-4 space-y-2.5 text-xs">
                <div className="text-xs font-bold text-amber-400 font-mono">精品手沖萃取三大不可逆定律</div>
                <ul className="space-y-2 text-[#f0eeeb]/70 leading-relaxed">
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400 font-bold">01.</span>
                    <span><strong className="text-white">前段釋放酸與花香：</strong> 悶蒸與前 40% 水量決定香氣與酸度細緻度。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400 font-bold">02.</span>
                    <span><strong className="text-white">中段釋放焦糖甜感：</strong> 60%~80% 水量萃取豐富糖類與水果熟甜。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400 font-bold">03.</span>
                    <span><strong className="text-white">後段只留純淨水感：</strong> 80% 後咖啡已無正面風味，維持中心溫柔水柱避免過萃苦澀。</span>
                  </li>
                </ul>
              </div>
            </div>
